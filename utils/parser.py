...
def get_args():
    ...
    parser.add_argument(
        ...
        action='store_true', 
        default=False, 
        help = 'partseg on shapenetpart')
    parser.add_argument(
        '--test_partseg', 
        action='store_true', 
        default=False, 
        help = 'test partseg on shapenetpart')
    parser.add_argument(
        '--mode', 
    ...
    if args.launcher == 'none':
        ...
        # using torchrun ddp, references: https://pytorch.org/docs/stable/elastic/run.html
    ...
    args.tfboard_path = args.experiment_path = os.path.join('./experiments', Path(args.config).stem, args.exp_name)
